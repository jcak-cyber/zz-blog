  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-sm border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          'border-border bg-[color-mix(in_srgb,var(--paper-bright)_70%,transparent)] text-[var(--ink-muted)] hover:border-[var(--accent)] hover:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)] hover:text-[var(--accent)] aria-expanded:border-[var(--accent)] aria-expanded:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)] aria-expanded:text-[var(--accent)]',
        secondary:
        ...
        ghost:
          'border border-border bg-[color-mix(in_srgb,var(--paper-bright)_70%,transparent)] text-[var(--ink-muted)] hover:border-[var(--accent)] hover:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)] hover:text-[var(--accent)] aria-expanded:border-[var(--accent)] aria-expanded:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)] aria-expanded:text-[var(--accent)]',
        destructive:
